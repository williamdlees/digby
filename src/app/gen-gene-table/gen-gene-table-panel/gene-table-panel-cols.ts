 export const columnInfo = [
   ...
   {id: 'gene_family', name: 'Gene Family', hidden: true, type: 'string', size: 'small-col', description: 'Gene family'},
   ...
   {id: 'sense', name: 'Sense', hidden: true, type: 'string', size: 'small-col', description: 'Sense of feature'},
